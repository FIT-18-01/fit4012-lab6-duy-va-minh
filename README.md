...
- **Thành viên 1 phụ trách chính**: Triển khai sender.py, kênh khóa (key channel), log gửi
- **Thành viên 2 phụ trách chính**: Triển khai receiver.py, kênh dữ liệu (data channel), giải mã
- **Phần làm chung**: aes_socket_utils.py, tests, report, threat model

## Demo roles

- **Demo Sender / kênh khóa / log gửi**: Phạm Minh Duy
- **Demo Receiver / kênh dữ liệu / giải mã**: Vũ Tuấn Minh
- **Cả hai cùng trả lời threat model and ethics**: Phạm Minh Duy và Vũ Tuấn Minh
